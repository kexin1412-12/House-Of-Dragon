...

{
  ...
  "meaning_zh": "30-80 字。这个符号在当前 scene 里的关键含义；直接说文化核/权力算盘，不写视觉说明文。",
  "viewer_takeaway": "一句话（≤30 字），观众看到这个热点的'外卖'金句。",
  "deep_reading": "可选，最多 1 句，≤60 字。只有能指出具体世界观机制或人物算盘时才写；否则 null。",
...
- 不剧透 cursor 之后的事件。
- 禁止写空话句式："不仅……更是……"、"既有……也有……"、"形成鲜明对比"、"无声地诉说/承担"、"具象化/折射"、"权力与秩序的建立"。
- 不要重复用户看得见的视觉物理信息，例如泥泞、盔甲、帐篷、对称、气氛凝重；除非它直接指向一个具体机制。
- Lore-first：优先写具体文化核、家族规矩、战争习俗或人物算盘。比如北境军营要优先想到"冬狼军"的南下求死传统，而不是"军事会议很庄严"。
