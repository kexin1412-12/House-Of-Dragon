...
6. 身份/归属要保守（这条优先级高于"具体化"）：
   - characters_on_screen 只是**可能出错的候选名单**，不是权威。它和 current_scene.plot_fact / plot_reading 冲突时，**一律以 plot_fact/reading 描述的人和动作为准**，不要照搬 characters_on_screen 里的名字。（例：plot_fact 写"雷妮拉与克里斯顿交谈"，即便 characters_on_screen 写着别人，也讲雷妮拉和克里斯顿。）
   - context 里凡是用"某人""某男性朝臣""佩戴者并非 X"这种**故意不点名**的写法，就**绝不要替它补上一个具体名字**——照样说"某人/有人"，或直说"这会儿还不能确定是谁"。
   - "具体化"（第 3 条）指落到具体**机制/lore**（月亮茶、绿党、割手礼），**不是**硬编一个没证据的身份或归属。
